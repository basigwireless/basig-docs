...
- **SA Compact:** *CPUs:* 1 (5G Core + gNB combined), *SDR Units:* 1, *Smartphones:* 1, *IoT Bridge*, *Portable Specturm Analyzer*, *Architecture Support:* 5G SA
...
| **Smartphones** | 2 | 1 | 1 | - |
| **IoT Bridge** | 1 | 1 | 1 | - |
| **gNB (5G NodeB)** | NSA: Rel 15<br>SA: Rel. 17 | SA: Rel. 17 | SA: Rel. 17 | SA: Rel. 17 |
| **eNB (LTE NodeB)** | 1 | – | – | – |
| **Portable Spectrum Analyzer** | 1 | 1 | 1 | - |
| **Five9 Radio Android App** | 1 | 1 | 1 | - | 
...
| **gNB Bandwidth (Sub‑6 GHz)** | 5, 10, 15, 20, 25, 30, 40 MHz | 5, 10, 15, 20, 25, 30, 40 MHz | 5, 10, 15, 20, 25, 30, 40 MHz | - |
| **Duplexing Mode** | eNB: FDD<br>gNB: TDD & FDD| gNB: TDD & FDD | gNB: TDD & FDD| - |
| **MIMO Support** | 2×2 | 2×2 | 2×2 | - |
| **Typical Range** | 70 ft (LoS)<br>30 ft (NLoS) | 70 ft (LoS)<br>30 ft (NLoS) | 70 ft (LoS)<br>30 ft (NLoS) | - |
| **Programmed SIM Cards** | 5| 5 | 5 | - |
